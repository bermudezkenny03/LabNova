  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 px-4 sm:px-6 flex items-center justify-between shrink-0">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        <Link
          to="/profile"
          className="flex items-center gap-2 sm:gap-3 pl-2 pr-2 py-1.5 rounded-lg hover:bg-gray-50 transition-colors group"
          title="Ver perfil"
        >
        ...
        <button
          ...
          title="Cerrar sesión"
          className="flex items-center gap-1.5 px-2 py-1.5 rounded-lg text-sm text-gray-500 hover:text-red-600 hover:bg-red-50 transition-colors"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
